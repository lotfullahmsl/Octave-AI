...
class UIManager {
    ...
    // Show meta prompt
    showMetaPrompt(prompt) {
        const metaPromptElement = document.getElementById('metaPrompt');
        if (metaPromptElement) {
            metaPromptElement.textContent = `Voice guidance: ${prompt}`;
        }
    }
